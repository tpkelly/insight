$(document)
    .ready(function() {
        ...
        d3.json('revenuereport.json', function(data) {
            ...
            var year = exampleGroup.addDimension(ndx, "year", function(d){return d.Year;}, function(d){return d.Year;});
            var office = exampleGroup.addDimension(ndx, "office", function(d){return d.Office;}, function(d){return d.Office;});
            var salesman = exampleGroup.addDimension(ndx, "salesman", function(d){return d.FullName;}, function(d){return d.FullName;});
            var date = exampleGroup.addDimension(ndx, "date", function(d){return d.Date;}, function(d){return d.Date;});
            ...
            var yearChart = new ColumnChart('', "#yearChart", year, yearData)
                                            ...
                                            .margin({bottom:70, left:80, right: 0, top:20});

            var officeChart = new RowChart('', "#officeChart", office, officeData)
                                            .width(300)
                                            .height(300)
                                            .barColor('#2980b9')
                                            .valueAccessor(function(d){return d.value.CurrentRevenue})
                                            .margin({bottom:0, left: 80, right: 0, top:0});
            ...
            var personChart = new RowChart('Staff', "#personChart", salesman, salesmanData)
                                            ...
                                            .redrawAxes(true)
                                            .orderable(true)
                                            .yAxisFormat(function(d){return d.split(" ")[0];})
                                            .invert(true)
                                            .yOrientation('right')
                                            .margin({bottom:0, left: 0, right: 80, top:0});
