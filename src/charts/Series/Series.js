...
insight.Series = function Series(name, data, x, y, color) {
     ...
     * @param {function} valueFunction - If provided, this function will be used to generate the tooltip text, otherwise the series default tooltipFunction will be used.
