...
jasmine.HtmlReporter.ReporterView = function(dom) {
    ...
    this.complete = function() {
        ...
        dom.banner.appendChild(this.createDom('span', {
            className: 'duration'
        }, "finished in " + ((new Date()
            .getTime() - this.startedAt.getTime()) / 1000) + "s"));
    };
...
jasmine.HtmlReporter.SpecView.prototype.appendFailureDetail = function() {
    ...
    var resultItems = this.spec.results()
        .getItems();
...
jasmine.TrivialReporter.prototype.reportRunnerResults = function(runner) {
    ...
    this.finishedAtSpan.appendChild(document.createTextNode("Finished at " + new Date()
        .toString()));
};
