...
function BulletChart(name, element, dimension, group) {
    ...
    this.createChart = function () {
        ...
        this.tooltipAccessor = function (item) { return "Target: " + item.value.Targets + ", Actuals: " + item.value.Actuals; };
    }
    ...
    this.init = function () {
        ...
        var bars = this.chart.selectAll("g")
          .data(this.group().all())
            .enter().append("g")
              .attr("class", "bullet")
              .attr("transform", function (d) { return "translate(0, " + self.y(d.key) + ")"; })
        ...
        var bullets = bars.append("rect")
                            ...
                            .attr("width", function (d) { return self.x(d.value.Actuals); })
        ...
        var targets = bars.append("rect")
                            .attr("class", "target")
                            .attr("x", function (d) { return self.x(d.value.Targets) + self.xBounds().start; })
                            .attr("width", 3)
                            .attr("fill", "#34495e")
                            .attr("height", function (d) { return self.y.rangeBand(); })
